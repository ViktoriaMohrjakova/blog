    ...
    <div class="join">
            ...
            @foreach ($elements as $element)
                ...
                @if (is_string($element))
                        <a class="join-item btn btn-disabled">{{$element}}</a>
                @endif
            ...
            @else
              <a  class="join-item btn btn-disabled" aria-disabled="true" aria-label="@lang('pagination.next')" aria-hidden="true">&rsaquo;</a>
